...
otcdocs_repo_name = 'opentelekomcloud-docs/enterprise-router'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/enterprise-router/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'network'
otcdocs_service_title = 'Enterprise Router'
otcdocs_service_type = 'er'
...
html_title = "Enterprise Router - API Reference"
